...
public class MockDetector implements CloneDetector {
    ...
    public void onIndexChange(DocumentIndex index) {
        ...
        CodeClone clone1 = new CodeClone("file:///home/jakob/Documents/CompilaServerTest/test02.cmp",
                new Range(new Position(2, 0), new Position(3, 0)));
        CodeClone clone2 = new CodeClone("file:///home/jakob/Documents/CompilaServerTest/test01.cmp",
